...
class SleepingMusicPage extends StatefulWidget {
  SleepingMusicPage({super.key});

  @override
  State<SleepingMusicPage> createState() => _SleepingMusicPageState();
}

class _SleepingMusicPageState extends State<SleepingMusicPage>
    with TickerProviderStateMixin {
  final List<String> sleepingTracks = [
    "Track 1: Serenity",
    "Track 2: Deep Sleep",
    "Track 3: Calm Waves",
  ];
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                itemCount: sleepingTracks.length,
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                                content:
                                    Text('Playing ${sleepingTracks[index]}')),
                          );
                        },
                      ),
                    ),
